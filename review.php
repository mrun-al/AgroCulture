...
<html>
<head>
	<title>RfarmQuipment: Product</title>
	<meta lang="eng">
	<meta charset="UTF-8">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-12 col-sm-6">
									...
									<p style="font: 30px Times new roman;">Equipment Owner : <?= $frow['fname']; ?></p>
									<p style="font: 30px Times new roman;">Rent : <?= $row['price'].' /-'; ?></p>
								</div>
							</div><br />
							<div class="row">
						...
						<div class="12u$">
                            <center>
                                <div class="row uniform">
                                    ...
                                    <div class="6u 12u$(large)">
                                        <a href="buyNow.php?pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;">Rent Now</a>
                                    </div>
                                </div>
                            </center>
                        </div>

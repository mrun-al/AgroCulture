		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="harvest" style="color: black;">Harvesting</option>
										<option value="irrigation" style="color: black;">Irrigation</option>
										<option value="gardening" style="color: black;">Gardening</option>
										<!-- <option value="fruit" style="color: black;">Harvesting</option>
										<option value="vegetable" style="color: black;">Irrigation</option>
										<option value="grain" style="color: black;">Gardening</option> -->
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
					...
					if(isset($_GET['type']) AND $_GET['type'] == "harvest")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'harvest'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "irrigation")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'irrigation'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "gardening")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'gardening'";
					}
					...
					<?php
						...
						?>
							...
							<blockquote><?php echo "Type : ".$row['pcat'].'';?><br><?php echo "Rent : ".$row['price'].' /-';?><br><a href="https://api.whatsapp.com/send?phone=+918693065721&amp;text=Hi, I need to rent this equipment" style="color:#ffffff; text-decoration:none;">Contact Farmer</a><br></blockquote>

	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2><span  class="notranslate" >RfarmQuipment</span></h2>
				...
				<div class="container">
					...
					<div class="row 200%">
						<section class="4u 12u$(small)">
							...
							<p><a href="https://pib.gov.in/Pressreleaseshare.aspx?PRID=1496069#:~:text=The%20Government%20has%20rolled%20out,PMFBY)%20and%20Interest%20Subvention%20Scheme." style="color: #ffffff; text-decoration: none;">Government Schemes</a></p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-comments"></i>
							<p><a href="blogView.php" style="color: #ffffff; text-decoration: none;">RfarmQuipment-Blog</a></p>
						</section>
						<section class="4u$ 12u$(small)">
							<i class="icon big rounded fa-user"></i>

							<!-- Mrunal whatsapp  -->
							<p><a href="https://api.whatsapp.com/send?phone=+918693065721&amp;text=Hi, I need to rent this equipment" style="color: #ffffff; text-decoration: none;">Whatsapp Us</a></p>
						</section>
					</div>
				</div>
			</section>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;" class="notranslate" >RfarmQuipment &copy; </h3>
			<!-- <div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Mumbai<span>Maharashtra</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+91 8693065721</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">mrunalubale99@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About RfarmQuipment</b></span>
				RfarmQuipment is a platform for renting equipments.
			</p>
